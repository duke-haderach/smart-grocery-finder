...
import type { GeocodeResult } from '../types/index'

// Cache for zipcode geocoding to reduce API calls
const geocodeCache = new Map<string, GeocodeResult>()

// Google Geocoding API service
async function geocodeWithGoogle(zipcode: string): Promise<GeocodeResult | null> {
...
function getMockLocationForZipcode(zipcode: string): GeocodeResult | null {
  const mockData: Record<string, GeocodeResult> = {
    // Major US Cities
